...
/*   Updated: 2021/12/23 10:49:37 by abougrin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string const name, int const sGrade, int const eGrade) : _name(name), _sign(false), _sGrade(sGrade), _eGrade(eGrade)
{
